...
$dbg_pic = $new_image_name;
	...
	$sql="INSERT INTO durabl_fba(serial,date,name,detail,d_number,dbg_pic,date_p,picker,price) VALUE('$serial','$date','$name','$detail','$d_number','$dbg_pic','$date_p','$picker','$price')";

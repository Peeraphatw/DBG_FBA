        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class=" col-xs-5 col-sm-8 col-md-6 col-lg-5 col-xl-3">
                            <div class="card shadow mb-3 ">
                                <div class="card-header py-3 bg-gradient-primary ">
                                    <h6 class="m-0 font-weight-bold text-gray-100 ">เพิ่มข้อมูลครุภัณฑ์เงินรายได้</h6>
                                </div>
                                <div class="card-body mx-auto ">
                                    <a href="#" class="btn btn-primary btn-icon-split" data-toggle="modal"
                                        ...
                                        <span class="text text-gray-100">เพิ่มรายการครุภัณฑ์เงินรายได้</span>
                                    </a>
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-gray-800">
                                                    <form name="insert" action="insertdbgBE.php" method="POST"
...
while ($rs = mysqli_fetch_array($result)){
  ...
  $num = number_format($rs[price],2,'.',',');
    ...
    <button type='button' class='btn btn-warning' data-toggle='modal' data-target='#modal$rs[id]'>แก้ไข</button>";
 ...
 <div class='modal fade' id='modal$rs[id]' tabindex='-1' role='dialog' aria-labelledby='exampleModalLongTitle' aria-hidden='true'>
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-body text-gray-800'>
      <form action='updatets.php' method='POST' enctype='multipart/form-data'>
                      <input type='hidden' name='eid' value='".$rs[id]."'>
                      <label for='titles'>หมายเลขครุภัณฑ์</label>
...
<!-- / -->";
    ...
    echo "</td>";
// จบปุ่มแก้ใข
    echo "<td><form action='deletedbgBE.php' method='POST'>
